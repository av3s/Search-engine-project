...
public enum MessagesAndErrorCodes {
    ...
    // Ошибки страниц и сайтов(2100-2199)
    ...
    PAGE_INVALID_CONNECT_TO_URL(0x2104, "Не удалось подключиться к странице"),
    SITE_ALREADY_EXISTS(0x2105, "Сайт уже существует в базе данных."),


    PAGE_REDIRECTION(0x2202, "Страница возвращает редирект (HTTP %d)"),
    PAGE_INFORMATIONAL(0x2204, "Получен информационный ответ (HTTP %d)"),
